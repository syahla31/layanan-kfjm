...
<body class="bg-[#f4f7ff] text-slate-800 antialiased overflow-hidden text-left">
    ...
    @php
        ...
        $categoryConfig = [
            'file_legalitas' => ['label' => 'Aspek Legalitas & Perizinan', 'bobot' => 10, 'icon' => 'fa-building', 'color' => 'blue'],
            ...
            'file_kurikulum' => ['label' => 'Kurikulum, Modul & Bahan Arang', 'bobot' => 20, 'icon' => 'fa-book-open', 'color' => 'rose']
        ];
    @endphp
    ...
    <div class="flex h-screen overflow-hidden w-full">
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-primary-900 transform -translate-x-full transition-transform duration-300 lg:translate-x-0 lg:static flex flex-col h-full border-r border-blue-900/20">
        ...
        <div class="flex-1 flex flex-col h-screen overflow-hidden relative w-full">
            ...
            <div class="hidden lg:block shrink-0">
                @include('components.pelatihan-header', ['title' => 'Evaluasi Surveilan', 'subtitle' => 'Panel Verifikasi & Penilaian Instrumen'])
            </div>
